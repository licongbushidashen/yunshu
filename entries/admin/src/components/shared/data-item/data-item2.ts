...
export abstract class OperatorService {
  ...
  static findByLabel(type: DataItemType, label: string) {
    ...
    } else if (type === DataItemType.StaffSingle || type === DataItemType.StaffMulti || type === DataItemType.DeptSingle
      || type === DataItemType.DeptMulti || type === DataItemType.StaffDeptMix) {
