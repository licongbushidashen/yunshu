  ...
  >
    ...
    <div v-else>
      ...
      <a-row>
        ...
        <a-col :span="18">
          <a-select show-search style="width: 100%" :disabled="!bizModel" v-model="sheetDataItem">
      ...
      <a-row>
        ...
        <a-col :span="18">
          <a-select show-search style="width: 100%" :disabled="!bizModel" v-model="orderByFields">
            <template v-for="item in targetDataItems">
              <a-select-option
                :value="item.code"
                :key="item.code"
      ...
      <a-row>
        ...
        <a-col :span="18" class="condition-col">
          ...
          <div v-for="(condition, index) in conditionList" :key="condition.key" class="select-wrap">
            <!-- 绑定表单的查询条件 -->
            <a-select
              :disabled="!bizModel"
            ...
            <!-- 操作符号 -->
            <a-select show-search v-model="condition.operator.val">
              <a-select-option
            ...
            <!-- 当前表单的 -->
            <a-select show-search :disabled="!condition.target.val" v-model="condition.current.val">
              <a-select-option
