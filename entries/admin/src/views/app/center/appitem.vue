  ...
  <div class="app-item">
    <div class="app-menu" v-resize.east>
      <div class="menu-tree">
        ...
        <multi-tree :treeData="floders" @treeSelect="onSelect" @dragEnd="dispatchMouseUpEvent"></multi-tree>
        <!-- <Draggable
          element="ul"
          :list="appMenu"
          :id="appDetails.id"
    ...
    <div class="app-router-wrap">
      <AppItemContent :curFolderId="curFolderId" @afterAddModel="showDataModel"></AppItemContent>
    </div>
  </div>
</template>
