  ...
  */
  static getDataConditionFilterMap(key:number|string):Array<number>{
    const dataConditionFilterMap:any = {
      ...
      [`type${DataItemType.StaffSingle}`]: [DataRuleTypes.DataConditionFilterType.OF, DataRuleTypes.DataConditionFilterType.EP, DataRuleTypes.DataConditionFilterType.NEP],
