<template>
  <div class="left-component">
    <div class="sys-columns">
      <div class="left-title">
        <span @click="upDownToggle($event, 'sysBool')">
          ...
          <i class="anticon anticon-right" v-show="!sysBool"></i> </span
        >系统字段
      </div>
    ...
    <div class="biz-columns">
      <div class="left-title">
        <span @click="upDownToggle($event, 'bizBool')">
          ...
          <i class="anticon anticon-right" v-show="!bizBool"></i> </span
        >业务字段
      </div>
      <div class="item-wrapper" v-show="bizBool">
        ...
        <div style="margin: 5px auto" v-show="bizColumns.length === 0">
          暂无业务字段
        </div>
      </div>
    </div>
    <div class="qr-bar-code">
      <div class="left-title">
        <span @click="upDownToggle($event, 'codeBool')">
          ...
          <i class="anticon anticon-right" v-show="!codeBool"></i> </span
        >二维码及条形码
      </div>
    ...
    <div class="flow-log" v-if="processShow">
      <div class="left-title">
