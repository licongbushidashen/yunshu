  ...
  <div class="left-attr">
    <div class="left-item qr-code" v-show="itemAttrs.eleType.includes('leftQrcodePic')">
      ...
      <div class="select-input">
        <a-select show-search v-model="itemAttrs.qrCreateOrShow">
    ...
    <div class="left-item" v-show="itemAttrs.eleType.includes('leftBarcodePic')">
      <p>条形码（code 128）</p>
      <div class="select-input">
        <a-select show-search v-model="itemAttrs.barCodeKey" @change="barCodeKeyChange(itemAttrs.barCodeKey)">
      ...
      <div class="select-input">
        <a-select show-search placeholder="请选择" v-model="itemAttrs.barCodeValue" v-if="itemAttrs.barCodeKey.includes('formColumn')">
