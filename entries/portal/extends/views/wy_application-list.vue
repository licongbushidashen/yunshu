              ...
              <template v-if="ac.actionCode !== 'batch_print'">
                ...
                <template v-else-if="ac.associationType == '10'">
                  <a-upload
                    ...
                    v-if="schemaCode == 'SRW' || schemaCode == 'ZDGZ'"
                  >
...
<script src="./wy_application-list.ts" />

<style lang="less">
.list-action-export {
  &::before {
    content: "";
    background: url("./wjdc.png");
    width: 16px;
    height: 16px;
...
.ant-upload-select-text .ant-btn {
  &::before {
    content: "";
    background: url("./dr.png");
    width: 16px;
    height: 16px;
    display: inline-block;
    background-size: 100% 100%;
...
.list-action-add {
  ...
  border: 1px solid #ba0505 !important;
  &::before {
    content: "";
...
.list-action-delete,
.list-action-qr_code,
.list-action-editowner,
.list-action-batch_print,
.list-action-batch_update {
  display: none;
}
...
/deep/.custom-template-container .table-head-wrapper.fixed-top-header {
