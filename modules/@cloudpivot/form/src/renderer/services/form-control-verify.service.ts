          ...
          switch (ruleObj.rule) {
            ...
            case ">":
              if (controlOptions.format === "HH:mm:ss") {
                options.min = moment(ruleObj.time, controlOptions.format).add(1, 's');
              } else {
                options.min = moment(ruleObj.time, controlOptions.format).add(1, 'm');
              }
              break;
            case "<":
              if (controlOptions.format === "HH:mm:ss") {
                options.max = moment(ruleObj.time, controlOptions.format).subtract(1, 's');
              } else {
                options.max = moment(ruleObj.time, controlOptions.format).subtract(1, 'm');
              }
              break;
            case ">=":
              options.min = moment(ruleObj.time, controlOptions.format);
