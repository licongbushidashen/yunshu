<template>
  <div class="upload-control-component" :class="{ 'upload-image': isImage, 'upload-files': !isImage }">
    ...
    <a-upload :action="uploadUrl" :beforeUpload="beforeUpload" :multiple="multi" :defaultFileList="fileList" :remove="onRemovedImg" :fileList="uploadFileList" :listType="listType" :headers="headers" @preview="handlePreview" @change="onChange" :uploadList="isImage" :class="{
      ...
      <file-list v-if="!isImage" :list="fileList" :eventList="eventList" :downUrls="ctrl.value" :showRm="isReadonly" @rm-file="rmFile" />
    </a-upload>
    ...
    <a-modal :visible="previewVisible" :footer="null" @cancel="handleCancel" :maskClosable="false" :keyboard="false">
