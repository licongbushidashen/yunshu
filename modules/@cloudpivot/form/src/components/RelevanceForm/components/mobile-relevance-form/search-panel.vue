...
export default class SearchPanel extends Vue {
  ...
  async doFetch() {
    ...
    try {
      const seg = await this.fetch(this.page, this.pageSize, this.value, this.queryFormState,view);
      console.log(seg,"seg------------------------------------------------");
  ...
  searchWays: Array<any> = this.showStyle === 'tree' && this.relevanceId === 'parentId' ? [
    {
      name: '单据状态',
      type: 'status',
