<template>
  <div class="warp">
    <div class="sheet">
        ...
        <template v-for="(col, colIdx) in freezeColumns">
          ...
          >
            ...
            <!-- <span style="color:#F4454E" v-if="getColumnRequired(col)">*</span> -->
              {{ getColumnLabel(col) }}
              <a-tooltip style="width:100%" placement="top" v-if="getTips(col)">
                <template slot="title">
      ...
      <div class="sheet__body" :class="{ 'show-total': showTotal }" :style="sheetBodyStyle">
        <div
          class="sheet__row"
        ...
        >
          ...
          <template v-for="(col, colIdx) in getFreezeCells(row)">
            ...
            >
              <a-tooltip style="width:100%" placement="topLeft" v-show="col.controller.display">
      ...
      <div class="sheet__row total" v-if="showTotal && hasStat && rows.length">
        <div
          class="center middle sheet__col"
          :class="{ 'shadow-left': shadowLeft && freezeColumns.length === 0 }"
        >
