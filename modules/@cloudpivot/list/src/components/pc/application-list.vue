<template>
  <div id="portal-form-list-container" class="app-menu">
    <div id="ApplicationList" class="application-box" ref="application">
      ...
      <div class="table-box" v-if="isShowTableBox">
        ...
        <div
          ...
          ref="paginationBox"
          v-if="cusColumns.length > 0 &&modelType !== 'TREE'"
        >
          <a-pagination
            :current="curPage"
            :total="total"
    ...
    <model-table-import
      ...
      @importEnd="importEnd"
      @close="handleCancel"
      @setData="confirm"></model-table-import>
...
<!--    </a-modal>-->
    ...
    <batch-update @updateOver="updateOver" @visibleChange="updateVisibleChange" :oldParams="oldParams"  :updateOptions ="updateOptions" />
...
.list-action-FORM_TRACK,.list-action-form_track {
  margin-left: 8px;
}
